...
export default function EventCard({ event }: EventCardProps) {
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden hover:translate-y-[-4px] transition-all duration-300 hover:shadow-xl card-gradient animate-fade-in">
      ...
      <div className="px-5 py-5 flex-grow flex flex-col">
        ...
        <div className="mt-5 pt-3 flex items-center justify-between border-t border-gray-100">
          <Badge variant="outline" className="bg-gradient-to-r from-green-50 to-green-100 text-green-800 font-medium border-green-200 shadow-sm py-1.5">
